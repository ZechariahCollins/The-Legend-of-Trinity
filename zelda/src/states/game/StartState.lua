...
function StartState:render()
    ...
    love.graphics.printf('Legend of Loltroll', 2, WINDOW_HEIGHT / 2 - 32, WINDOW_WIDTH, 'center')

    --love.graphics.setColor(175/255, 53/255, 42/255, 1)
    love.graphics.setColor(0/255, 0/255, 0/255, 1)
    love.graphics.printf('Legend of Loltroll', 0, WINDOW_HEIGHT / 2 - 32, WINDOW_WIDTH, 'center')
